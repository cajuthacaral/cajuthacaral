...
export default function ScratchPage() {
    ...
    return (
        <div className="scratch-wind-container">
            ...
            <iframe src="https://scratch.mit.edu/projects/1077313388/embed" allowtransparency="true" width="485" height="402" frameborder="0" scrolling="no" allowfullscreen></iframe>
